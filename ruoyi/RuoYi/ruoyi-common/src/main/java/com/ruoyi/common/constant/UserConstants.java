...
public class UserConstants {
    ...
    /** 商品种类编号是否唯一的返回结果码 */
    public final static String GOOD_TYPE_CODE_UNIQUE = "0";
    public final static String GOOD_TYPE_CODE_NOT_UNIQUE = "1";

    /** 商品种类编号是否唯一的返回结果码 */
    public final static String GOOD_NAME_UNIQUE = "0";
    public final static String GOOD_NAME_NOT_UNIQUE = "1";

    /** 商品批次种类编号是否存在的返回结果码 */
    public final static String GOOD_TYPE_CODE_EXIST = "0";
    public final static String GOOD_TYPE_CODE_NOT_EXIST = "1";

    /** 商品种类名称是否存在的返回结果码 */
    public final static String GOOD_NAME_EXIST = "0";
    public final static String GOOD_NAME_NOT_EXIST = "1";
